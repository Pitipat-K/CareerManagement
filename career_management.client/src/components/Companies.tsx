...
const Companies = () => {
  ...
  const handleDelete = async (id: number) => {
    if (window.confirm('Are you sure you want to delete this company?')) {
      try {
        await axios.delete(`https://localhost:7026/api/companies/${id}`);
        fetchCompanies();
      } catch (error) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingCompany) {
        ...
        await axios.put(`https://localhost:7026/api/companies/${editingCompany.companyID}`, {
          ...companyData,
        ...
        // Create new company
        await axios.post('https://localhost:7026/api/companies', companyData);
      }
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                    errors.directorID ? 'border-red-500' : 'border-gray-300'
                  }`}
                >
